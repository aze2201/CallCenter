...
def render_page(request, page, current_language, slug):
	...
	print (request.COOKIES)
        os.system('export mytoken='+str(request.COOKIES['csrftoken']))
        os.system('env > /var/www/callcenter/core/env.txt')
        os.system('echo '+str(request.COOKIES)+'> /var/www/callcenter/core/cache/req.cookies.txt')
        os.system("echo '"+str(request.COOKIES['sessionid'])+"|"+str(request.COOKIES['csrftoken'])+"|"+str(request.user)+"'"+ "> /var/www/callcenter/core/cache/"+str(request.user)+".csrf")
        os.system("echo "+str(request.COOKIES['csrftoken'])+ "> /var/www/callcenter/core/cache/"+str(request.user)+"_token")
    os.system('export mytoken='+str(request.COOKIES['csrftoken']))
